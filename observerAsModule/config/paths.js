...
module.exports = {
  ...
  observerPath: resolveApp("node_modules/earthruntime")
};

let checkForMonorepo = true;

module.exports.srcPaths = [module.exports.appSrc, module.exports.observerPath];
console.log("srcpaths", module.exports.srcPaths);
